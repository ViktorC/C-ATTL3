...
#include "device_specific/builtin_database/devices/gpu/amd/northern_islands/barts.hpp"

#include "device_specific/builtin_database/devices/gpu/nvidia/fermi/tesla_c2050.hpp"

#include "device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gtx_470.hpp"

#include "device_specific/builtin_database/devices/gpu/nvidia/maxwell/geforce_gtx_750_ti.hpp"

#include "device_specific/builtin_database/devices/gpu/amd/northern_islands/scrapper.hpp"

#include "device_specific/builtin_database/devices/gpu/nvidia/tesla/geforce_gtx_260.hpp"

#include "device_specific/builtin_database/devices/gpu/amd/southern_islands/tahiti.hpp"
#include "device_specific/builtin_database/devices/gpu/amd/northern_islands/devastator.hpp"

#include "device_specific/builtin_database/devices/gpu/nvidia/kepler/tesla_k20m.hpp"
#include "device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gtx_580.hpp"

#include "device_specific/builtin_database/devices/gpu/amd/volcanic_islands/hawaii.hpp"

#include "device_specific/builtin_database/devices/gpu/amd/evergreen/cypress.hpp"
#include "device_specific/builtin_database/devices/gpu/amd/evergreen/cedar.hpp"


#include "device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gt_540m.hpp"


#include "ocl/device_utils.hpp"
#include "scheduler/forwards.h"

#include "device_specific/builtin_database/devices/accelerator/fallback.hpp"
#include "device_specific/builtin_database/devices/cpu/fallback.hpp"
#include "device_specific/builtin_database/devices/gpu/fallback.hpp"
#include "device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gt_540m.hpp"

/** @file device_specific/builtin_database/matrix_product.hpp
*
