...
/** @file scheduler/execute_scalar_dispatcher.hpp
    @brief Provides wrappers for as(), asbs(), asbs_s(), etc. in linalg/scalar_operations.hpp such that scheduler logic is not cluttered with numeric type decutions
*/
...
#include "scheduler/execute_util.hpp"
#include "linalg/scalar_operations.hpp"
