...
/** @file scheduler/execute_matrix_dispatcher.hpp
    @brief Provides wrappers for am(), ambm(), ambm_m(), etc. in linalg/matrix_operations.hpp such that scheduler logic is not cluttered with numeric type decutions
*/
