...
/** @file scheduler/execute_vector_dispatcher.hpp
    @brief Provides wrappers for av(), avbv(), avbv_v(), etc. in linalg/vector_operations.hpp such that scheduler logic is not cluttered with numeric type decutions
*/
