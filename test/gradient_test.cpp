 ...
 * @param abs_epsilon The maximum acceptable absolute difference between the
 * analytic and numerical gradients.
 * @param rel_epsilon The maximum acceptable relative difference between the
 * analytic and numerical gradients.
 */
...
inline void grad_test(std::string name, DataProvider<Scalar, Rank, Sequential>& prov,
                      ...
                      Scalar step_size = ScalarTraits<Scalar>::step_size,
...
inline void nonseq_network_grad_test(std::string name, NeuralNetPtr<Scalar, Rank, false> net, std::size_t samples = 5,
                                     Scalar step_size = ScalarTraits<Scalar>::step_size,
                                     Scalar abs_epsilon = ScalarTraits<Scalar>::abs_epsilon,
                                     Scalar rel_epsilon = ScalarTraits<Scalar>::rel_epsilon) {
...
inline void seq_network_grad_test(std::string name, NeuralNetPtr<Scalar, Rank, true> net,
                                  std::size_t input_seq_length = 5, std::size_t output_seq_length = 5,
...
inline void dense_kernel_gpu_layer_grad_test() {
  ...
  LayerPtr<Scalar, 1> layer1_2(
      new cattle::gpu::DenseKernelGPULayer<Scalar, 1>(layer1_1->get_output_dims(), 1, init1, reg));
  ...
  LayerPtr<Scalar, 2> layer2_2(
      new cattle::gpu::DenseKernelGPULayer<Scalar, 2>(layer2_1->get_output_dims(), 2, init2, reg));
  ...
  LayerPtr<Scalar, 3> layer3_2(
      new cattle::gpu::DenseKernelGPULayer<Scalar, 3>(layer3_1->get_output_dims(), 4, init1, reg));
  layer_grad_test<Scalar, 3>("dense kernel GPU layer", std::move(layer3_1), std::move(layer3_2));
}

TEST(GradientTest, DenseKernelGPULayer) { dense_kernel_gpu_layer_grad_test<double>(); }
...
TEST(GradientTest, DenseKernelLayer) { dense_kernel_layer_grad_test<double>(); }
...
inline void conv_kernel_layer_grad_test() {
  ...
  LayerPtr<Scalar, 2> layer2_2(
      new ConvKernelLayer<Scalar, 2>(layer1_2->get_output_dims(), 1, init, 2, 2, 1, 1, 1, 1, 0, 0, reg));
  ...
  LayerPtr<Scalar, 3> layer2_3(
      new ConvKernelLayer<Scalar>(layer1_3->get_output_dims(), 1, init, 2, 2, 1, 1, 1, 1, 0, 0, reg));
  layer_grad_test<Scalar, 3>("convolution kernel layer ", std::move(layer1_3), std::move(layer2_3));
}

TEST(GradientTest, ConvKernelLayer) { conv_kernel_layer_grad_test<double>(); }
...
inline void trans_conv_kernel_layer_grad_test() {
  ...
  LayerPtr<Scalar, 1> layer2_1(
      new TransConvKernelLayer<Scalar, 1>(layer1_1->get_output_dims(), 1, init, 1, 1, 1, 0, reg));
  ...
  LayerPtr<Scalar, 2> layer2_2(
      new TransConvKernelLayer<Scalar, 2>(layer1_2->get_output_dims(), 1, init, 2, 2, 1, 1, 1, 1, 0, 0, reg));
  ...
  LayerPtr<Scalar, 3> layer2_3(
      new TransConvKernelLayer<Scalar>(layer1_3->get_output_dims(), 1, init, 2, 2, 1, 1, 1, 1, 0, 0, reg));
  layer_grad_test<Scalar, 3>("trans_convolution kernel layer ", std::move(layer1_3), std::move(layer2_3));
}

TEST(GradientTest, TransConvKernelLayer) { trans_conv_kernel_layer_grad_test<double>(); }
...
TEST(GradientTest, ActivationLayer) { activation_layer_grad_test<double>(); }
...
TEST(GradientTest, PoolLayer) { pool_layer_grad_test<double>(); }
...
TEST(GradientTest, BroadcastLayer) { broadcast_layer_grad_test<double>(); }
...
inline void batch_norm_layer_grad_test() {
  ...
  LayerPtr<Scalar, 1> layer1_2(new BatchNormLayer<Scalar, 1>(
      layer1_1->get_output_dims(), .2, NumericUtils<Scalar>::EPSILON2, reg2, 0, 0, 0, 0, 0, 0, reg1));
  layer_grad_test<Scalar, 1>("per-activation batch norm layer", std::move(layer1_1), std::move(layer1_2), 5,
                             ScalarTraits<Scalar>::step_size, ScalarTraits<float>::abs_epsilon,
                             ScalarTraits<float>::rel_epsilon);
  ...
  LayerPtr<Scalar, 3> layer3_2(new BatchNormLayer<Scalar, 3>(
      layer3_1->get_output_dims(), .1, NumericUtils<Scalar>::EPSILON2, reg2, 0, 0, 0, 0, 0, 0, reg2));
  ...
  LayerPtr<Scalar, 3> layer3_4(new BatchNormLayer<Scalar, 3, false>(
      layer3_3->get_output_dims(), .05, NumericUtils<Scalar>::EPSILON2, reg2, 0, 0, 0, 0, 0, 0, reg2));
  layer_grad_test<Scalar, 3>("per-activation batch norm layer", std::move(layer3_3), std::move(layer3_4));
}

TEST(GradientTest, BatchNormLayer) { batch_norm_layer_grad_test<double>(); }
...
TEST(GradientTest, ReshapeLayer) { reshape_layer_grad_test<double>(); }
...
inline void parallel_net_grad_test() {
  ...
  lanes1_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(lane1_1_1_layers))));
  ...
  lane2_1_1_layers[1] =
      LayerPtr<Scalar, 1>(new SigmoidActivationLayer<Scalar, 1>(lane2_1_1_layers[0]->get_output_dims()));
  lane2_1_1_layers[2] =
      LayerPtr<Scalar, 1>(new DenseKernelLayer<Scalar, 1>(lane2_1_1_layers[1]->get_output_dims(), 6, init));
  lanes1_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(lane2_1_1_layers))));
  ...
  lane3_1_1_layers[1] =
      LayerPtr<Scalar, 1>(new DenseKernelLayer<Scalar, 1>(lane3_1_1_layers[0]->get_output_dims(), 6, init));
  lanes1_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(lane3_1_1_layers))));
  NeuralNetPtr<Scalar, 1, false> parallel_net1_1(
      new ParallelNeuralNetwork<Scalar, 1, PARALLEL_SUM>(std::move(lanes1_1)));
  ...
  lanes2_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(lane1_2_1_layers))));
  ...
  lane2_2_1_layers[1] =
      LayerPtr<Scalar, 1>(new SigmoidActivationLayer<Scalar, 1>(lane2_2_1_layers[0]->get_output_dims()));
  lane2_2_1_layers[2] =
      LayerPtr<Scalar, 1>(new DenseKernelLayer<Scalar, 1>(lane2_2_1_layers[1]->get_output_dims(), 6, init));
  lanes2_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(lane2_2_1_layers))));
  ...
  lane3_2_1_layers[1] =
      LayerPtr<Scalar, 1>(new DenseKernelLayer<Scalar, 1>(lane3_2_1_layers[0]->get_output_dims(), 6, init));
  lanes2_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(lane3_2_1_layers))));
  NeuralNetPtr<Scalar, 1, false> parallel_net2_1(
      new ParallelNeuralNetwork<Scalar, 1, PARALLEL_MUL>(std::move(lanes2_1)));
  ...
  NeuralNetPtr<Scalar, 2, false> parallel_net_2(
      new ParallelNeuralNetwork<Scalar, 2, PARALLEL_CONCAT_LO_RANK>(std::move(lanes_2)));
...
TEST(GradientTest, ParallelNet) { parallel_net_grad_test<double>(); }
...
inline void residual_net_grad_test() {
  ...
  sub_modules1_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(layers1_1))));
  sub_modules1_1.push_back(NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(
      LayerPtr<Scalar, 1>(new DenseKernelLayer<Scalar, 1>(sub_modules1_1[0]->get_output_dims(), 32, init)))));
  modules_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new StackedNeuralNetwork<Scalar, 1, false>(std::move(sub_modules1_1))));
  modules_1.push_back(NeuralNetPtr<Scalar, 1, false>(
      new StackedNeuralNetwork<Scalar, 1, false>(NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(
          LayerPtr<Scalar, 1>(new DenseKernelLayer<Scalar, 1>(modules_1[0]->get_output_dims(), 32, init)))))));
  nonseq_network_grad_test<Scalar, 1>(
      "residual net", NeuralNetPtr<Scalar, 1, false>(new ResidualNeuralNetwork<Scalar, 1>(std::move(modules_1))));
  // Rank 3.
  ...
  sub_modules1_3.push_back(
      NeuralNetPtr<Scalar, 3, false>(new FeedforwardNeuralNetwork<Scalar, 3>(std::move(layers1_3))));
  sub_modules1_3.push_back(NeuralNetPtr<Scalar, 3, false>(new FeedforwardNeuralNetwork<Scalar, 3>(
      LayerPtr<Scalar, 3>(new ConvKernelLayer<Scalar>(sub_modules1_3[0]->get_output_dims(), 3, init)))));
  modules_3.push_back(
      NeuralNetPtr<Scalar, 3, false>(new StackedNeuralNetwork<Scalar, 3, false>(std::move(sub_modules1_3))));
  modules_3.push_back(NeuralNetPtr<Scalar, 3, false>(
      new StackedNeuralNetwork<Scalar, 3, false>(NeuralNetPtr<Scalar, 3, false>(new FeedforwardNeuralNetwork<Scalar, 3>(
          LayerPtr<Scalar, 3>(new ConvKernelLayer<Scalar>(modules_3[0]->get_output_dims(), 3, init)))))));
  nonseq_network_grad_test<Scalar, 3>(
      "residual net", NeuralNetPtr<Scalar, 3, false>(new ResidualNeuralNetwork<Scalar, 3>(std::move(modules_3))));
}

TEST(GradientTest, ResidualNet) { residual_net_grad_test<double>(); }
...
inline void dense_net_grad_test() {
  ...
  modules_1.push_back(
      NeuralNetPtr<Scalar, 1, false>(new StackedNeuralNetwork<Scalar, 1, false>(std::move(sub_modules1_1))));
  modules_1.push_back(NeuralNetPtr<Scalar, 1, false>(new StackedNeuralNetwork<Scalar, 1, false>(
      NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(LayerPtr<Scalar, 1>(
          new DenseKernelLayer<Scalar, 1>(dims_1.add_along_rank(modules_1[0]->get_output_dims(), 0), 16, init)))))));
  nonseq_network_grad_test<Scalar, 1>(
      "dense net", NeuralNetPtr<Scalar, 1, false>(new DenseNeuralNetwork<Scalar, 1>(std::move(modules_1))));
  // Rank 2.
  Dimensions<std::size_t, 2> dims_2({6u, 6u});
  ...
  sub_modules1_2.push_back(
      NeuralNetPtr<Scalar, 2, false>(new FeedforwardNeuralNetwork<Scalar, 2>(std::move(layers1_2))));
  sub_modules1_2.push_back(NeuralNetPtr<Scalar, 2, false>(new FeedforwardNeuralNetwork<Scalar, 2>(
      LayerPtr<Scalar, 2>(new DenseKernelLayer<Scalar, 2>(sub_modules1_2[0]->get_output_dims(), 6, init)))));
  modules_2.push_back(
      NeuralNetPtr<Scalar, 2, false>(new StackedNeuralNetwork<Scalar, 2, false>(std::move(sub_modules1_2))));
  modules_2.push_back(NeuralNetPtr<Scalar, 2, false>(new StackedNeuralNetwork<Scalar, 2, false>(
      NeuralNetPtr<Scalar, 2, false>(new FeedforwardNeuralNetwork<Scalar, 2>(LayerPtr<Scalar, 2>(
          new DenseKernelLayer<Scalar, 2>(dims_2.add_along_rank(modules_2[0]->get_output_dims(), 1), 6, init)))))));
  nonseq_network_grad_test<Scalar, 2>(
      "dense net",
      NeuralNetPtr<Scalar, 2, false>(new DenseNeuralNetwork<Scalar, 2, DENSE_HIGHEST_RANK>(std::move(modules_2))));
  // Rank 3.
  Dimensions<std::size_t, 3> dims_3({4u, 4u, 3u});
  std::vector<NeuralNetPtr<Scalar, 3, false>> modules_3;
  std::vector<NeuralNetPtr<Scalar, 3, false>> sub_modules1_3;
  ...
  modules_3.push_back(
      NeuralNetPtr<Scalar, 3, false>(new StackedNeuralNetwork<Scalar, 3, false>(std::move(sub_modules1_3))));
  modules_3.push_back(NeuralNetPtr<Scalar, 3, false>(new StackedNeuralNetwork<Scalar, 3, false>(
      NeuralNetPtr<Scalar, 3, false>(new FeedforwardNeuralNetwork<Scalar, 3>(LayerPtr<Scalar, 3>(
          new ConvKernelLayer<Scalar>(dims_3.add_along_rank(modules_3[0]->get_output_dims(), 0), 3, init)))))));
  nonseq_network_grad_test<Scalar, 3>(
      "dense net",
      NeuralNetPtr<Scalar, 3, false>(new DenseNeuralNetwork<Scalar, 3, DENSE_LOWEST_RANK>(std::move(modules_3))));
}

TEST(GradientTest, DenseNet) { dense_net_grad_test<double>(); }
...
inline void sequential_net_grad_test() {
  ...
  seq_network_grad_test(
      "sequential net",
      NeuralNetPtr<Scalar, 1, true>(new SequentialNeuralNetwork<Scalar, 1>(
          NeuralNetPtr<Scalar, 1, false>(new FeedforwardNeuralNetwork<Scalar, 1>(std::move(layers_1))))));
  // Rank 3.
  ...
  seq_network_grad_test(
      "sequential net",
      NeuralNetPtr<Scalar, 3, true>(new SequentialNeuralNetwork<Scalar, 3>(
          NeuralNetPtr<Scalar, 3, false>(new FeedforwardNeuralNetwork<Scalar, 3>(std::move(layers_3))))));
}

TEST(GradientTest, SequentialNet) { sequential_net_grad_test<double>(); }
...
inline void recurrent_net_grad_test() {
  ...
  KernelPtr<Scalar, 1> state_kernel1_1(
      new DenseKernelLayer<Scalar, 1>(input_kernel1_1->get_output_dims(), 12, init, reg));
  KernelPtr<Scalar, 1> output_kernel1_1(
      new DenseKernelLayer<Scalar, 1>(state_kernel1_1->get_output_dims(), 4, init, reg));
  ...
  seq_network_grad_test(
      "recurrent net",
      NeuralNetPtr<Scalar, 1, true>(new RecurrentNeuralNetwork<Scalar, 1>(
          std::move(input_kernel1_1), std::move(state_kernel1_1), std::move(output_kernel1_1), std::move(state_act1_1),
          std::move(output_act1_1), [](int input_seq_length) { return std::make_pair(input_seq_length, 0); })),
      3, 3);
  seq_network_grad_test(
      "recurrent net with multiplicative integration",
      NeuralNetPtr<Scalar, 1, true>(new RecurrentNeuralNetwork<Scalar, 1, true>(
          std::move(input_kernel2_1), std::move(state_kernel2_1), std::move(output_kernel2_1), std::move(state_act2_1),
          std::move(output_act2_1), [](int input_seq_length) { return std::make_pair(1, input_seq_length - 1); })),
      5, 1);
  // Rank 3.
  KernelPtr<Scalar, 3> input_kernel1_3(new ConvKernelLayer<Scalar>({4u, 4u, 2u}, 5, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> state_kernel1_3(
      new ConvKernelLayer<Scalar>(input_kernel1_3->get_output_dims(), 5, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> output_kernel1_3(
      new DenseKernelLayer<Scalar, 3>(state_kernel1_3->get_output_dims(), 2, init, reg));
  ...
  seq_network_grad_test("recurrent net",
                        NeuralNetPtr<Scalar, 3, true>(new RecurrentNeuralNetwork<Scalar, 3>(
                            std::move(input_kernel1_3), std::move(state_kernel1_3), std::move(output_kernel1_3),
                            std::move(state_act1_3), std::move(output_act1_3),
                            [](std::size_t input_seq_length) { return std::make_pair(3, input_seq_length - 3); })),
                        5, 3);
  seq_network_grad_test(
      "recurrent net with multiplicative integration",
      NeuralNetPtr<Scalar, 3, true>(new RecurrentNeuralNetwork<Scalar, 3, true>(
          std::move(input_kernel2_3), std::move(state_kernel2_3), std::move(output_kernel2_3), std::move(state_act2_3),
          std::move(output_act2_3), [](std::size_t input_seq_length) { return std::make_pair(2, input_seq_length); })),
      3, 2);
}

TEST(GradientTest, RecurrentNet) { recurrent_net_grad_test<double>(); }
...
inline void lstm_net_grad_test() {
  ...
  KernelPtr<Scalar, 1> forget_input_kernel2_1(
      static_cast<DenseKernelLayer<Scalar, 1>*>(forget_input_kernel1_1->clone()));
  KernelPtr<Scalar, 1> forget_output_kernel2_1(
      static_cast<DenseKernelLayer<Scalar, 1>*>(forget_output_kernel1_1->clone()));
  KernelPtr<Scalar, 1> write_input_kernel2_1(static_cast<DenseKernelLayer<Scalar, 1>*>(write_input_kernel1_1->clone()));
  KernelPtr<Scalar, 1> write_output_kernel2_1(
      static_cast<DenseKernelLayer<Scalar, 1>*>(write_output_kernel1_1->clone()));
  KernelPtr<Scalar, 1> candidate_input_kernel2_1(
      static_cast<DenseKernelLayer<Scalar, 1>*>(candidate_input_kernel1_1->clone()));
  KernelPtr<Scalar, 1> candidate_output_kernel2_1(
      static_cast<DenseKernelLayer<Scalar, 1>*>(candidate_output_kernel1_1->clone()));
  ...
  seq_network_grad_test(
      "lstm net",
      NeuralNetPtr<Scalar, 1, true>(new LSTMNeuralNetwork<Scalar, 1>(
          std::move(forget_input_kernel1_1), std::move(forget_output_kernel1_1), std::move(write_input_kernel1_1),
          std::move(write_output_kernel1_1), std::move(candidate_input_kernel1_1),
          ...
          std::move(read_act1_1), [](std::size_t input_seq_length) { return std::make_pair(input_seq_length, 0); })),
      3, 3);
  seq_network_grad_test(
      "lstm net with multiplicative integration",
      NeuralNetPtr<Scalar, 1, true>(new LSTMNeuralNetwork<Scalar, 1, true>(
          std::move(forget_input_kernel2_1), std::move(forget_output_kernel2_1), std::move(write_input_kernel2_1),
          std::move(write_output_kernel2_1), std::move(candidate_input_kernel2_1),
          ...
          std::move(read_act2_1),
          [](std::size_t input_seq_length) { return std::make_pair(1, input_seq_length - 1); })),
      5, 1);
  // Rank 3.
  Dimensions<std::size_t, 3> input_dims_3({5u, 3u, 3u});
  Dimensions<std::size_t, 3> output_dims_3({3u, 3u, 3u});
  KernelPtr<Scalar, 3> forget_input_kernel1_3(
      new ConvKernelLayer<Scalar>(input_dims_3, 3, init, 3, 3, 0, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> forget_output_kernel1_3(
      new ConvKernelLayer<Scalar>(output_dims_3, 3, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> write_input_kernel1_3(
      new ConvKernelLayer<Scalar>(input_dims_3, 3, init, 3, 3, 0, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> write_output_kernel1_3(
      new ConvKernelLayer<Scalar>(output_dims_3, 3, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> candidate_input_kernel1_3(
      new ConvKernelLayer<Scalar>(input_dims_3, 3, init, 3, 3, 0, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> candidate_output_kernel1_3(
      new ConvKernelLayer<Scalar>(output_dims_3, 3, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> read_input_kernel1_3(
      new ConvKernelLayer<Scalar>(input_dims_3, 3, init, 3, 3, 0, 1, 1, 1, 0, 0, reg));
  KernelPtr<Scalar, 3> read_output_kernel1_3(
      new ConvKernelLayer<Scalar>(output_dims_3, 3, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  ...
  KernelPtr<Scalar, 3> candidate_input_kernel2_3(
      static_cast<ConvKernelLayer<Scalar>*>(candidate_input_kernel1_3->clone()));
  KernelPtr<Scalar, 3> candidate_output_kernel2_3(
      static_cast<ConvKernelLayer<Scalar>*>(candidate_output_kernel1_3->clone()));
  ...
  seq_network_grad_test(
      "lstm net",
      NeuralNetPtr<Scalar, 3, true>(new LSTMNeuralNetwork<Scalar, 3>(
          std::move(forget_input_kernel1_3), std::move(forget_output_kernel1_3), std::move(write_input_kernel1_3),
          std::move(write_output_kernel1_3), std::move(candidate_input_kernel1_3),
          ...
          std::move(read_act1_3),
          [](std::size_t input_seq_length) { return std::make_pair(3, input_seq_length - 3); })),
      5, 3);
  seq_network_grad_test(
      "lstm net with multiplicative integration",
      NeuralNetPtr<Scalar, 3, true>(new LSTMNeuralNetwork<Scalar, 3, true>(
          std::move(forget_input_kernel2_3), std::move(forget_output_kernel2_3), std::move(write_input_kernel2_3),
          std::move(write_output_kernel2_3), std::move(candidate_input_kernel2_3),
          ...
          std::move(read_act2_3), [](std::size_t input_seq_length) { return std::make_pair(2, input_seq_length); })),
      3, 2);
}

TEST(GradientTest, LSTMNet) { lstm_net_grad_test<double>(); }
...
inline void bidirectional_net_grad_test() {
  ...
  KernelPtr<Scalar, 3> state_kernel1(
      new ConvKernelLayer<Scalar>(input_kernel1->get_output_dims(), 5, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  ...
  seq_network_grad_test(
      "bidirectional recurrent net with highest rank concatenation",
      NeuralNetPtr<Scalar, 3, true>(new BidirectionalNeuralNetwork<Scalar, 3, BIDIRECTIONAL_CONCAT_HI_RANK>(
          UnidirNeuralNetPtr<Scalar, 3>(new RecurrentNeuralNetwork<Scalar, 3, true>(
              std::move(input_kernel1), std::move(state_kernel1), std::move(output_kernel1), std::move(state_act1),
              std::move(output_act1), [](std::size_t input_seq_length) { return std::make_pair(3, 2); })))),
      7, 3);
  ...
  seq_network_grad_test(
      "bidirectional lstm net with lowest rank concatenation",
      NeuralNetPtr<Scalar, 2, true>(new BidirectionalNeuralNetwork<Scalar, 2, BIDIRECTIONAL_CONCAT_LO_RANK>(
          UnidirNeuralNetPtr<Scalar, 2>(new LSTMNeuralNetwork<Scalar, 2, true>(
              std::move(forget_input_kernel2), std::move(forget_output_kernel2), std::move(write_input_kernel2),
              std::move(write_output_kernel2), std::move(candidate_input_kernel2), std::move(candidate_output_kernel2),
              std::move(read_input_kernel2), std::move(read_output_kernel2), std::move(forget_act2),
              std::move(write_act2), std::move(candidate_act2), std::move(state_act2), std::move(read_act2),
              [](std::size_t input_seq_length) { return std::make_pair(1, 2); })))),
      5, 1);
  ...
  seq_network_grad_test(
      "bidirectional recurrent net with summation",
      NeuralNetPtr<Scalar, 1, true>(new BidirectionalNeuralNetwork<Scalar, 1, BIDIRECTIONAL_SUM>(
          UnidirNeuralNetPtr<Scalar, 1>(new RecurrentNeuralNetwork<Scalar, 1>(
              std::move(input_kernel3), std::move(state_kernel3), std::move(output_kernel3), std::move(state_act3),
              std::move(output_act3), [](std::size_t input_seq_length) { return std::make_pair(5, 2); })))),
      7, 5);
  ...
  KernelPtr<Scalar, 3> state_kernel4(
      new ConvKernelLayer<Scalar>(input_kernel4->get_output_dims(), 5, init, 3, 3, 1, 1, 1, 1, 0, 0, reg));
  ...
  seq_network_grad_test(
      "bidirectional recurrent net with multiplication",
      NeuralNetPtr<Scalar, 3, true>(new BidirectionalNeuralNetwork<Scalar, 3, BIDIRECTIONAL_MUL>(
          UnidirNeuralNetPtr<Scalar, 3>(new RecurrentNeuralNetwork<Scalar, 3, true>(
              std::move(input_kernel4), std::move(state_kernel4), std::move(output_kernel4), std::move(state_act4),
              std::move(output_act4), [](std::size_t input_seq_length) { return std::make_pair(3, 2); })))),
      7, 3);
}

TEST(GradientTest, BidirectionalNet) { bidirectional_net_grad_test<double>(); }
 ...
 * @param time_steps The number of time steps for sequential loss gradient
 * testing.
 */
template <typename Scalar, std::size_t Rank>
...
TEST(GradientTest, NegatedLoss) { negated_loss_grad_test<double>(); }
...
TEST(GradientTest, AbsoluteLoss) { absolute_loss_grad_test<double>(); }
...
TEST(GradientTest, HingeLoss) { hinge_loss_grad_test<double>(); }
...
inline void binary_cross_entropy_loss_grad_test(const Dimensions<std::size_t, Rank>& dims, std::size_t samples = 5,
  ...
  // Non-sequential.
  std::vector<LayerPtr<Scalar, Rank>> layers(2);
  layers[0] = LayerPtr<Scalar, Rank>(new DenseKernelLayer<Scalar, Rank>(
      dims, 1, ParamInitSharedPtr<Scalar>(new GlorotParameterInitialization<Scalar>())));
  ...
  *obj_tensor = obj_tensor->unaryExpr([](Scalar i) { return (Scalar)(i >= 0 ? 1 : 0); });
  MemoryDataProvider<Scalar, Rank, false> prov(random_tensor<Scalar, Rank + 1>(batch_dims), std::move(obj_tensor));
...
TEST(GradientTest, BinaryCrossEntropyLoss) { binary_cross_entropy_loss_grad_test<double>(); }
...
TEST(GradientTest, CrossEntropyLoss) { cross_entropy_loss_grad_test<double>(); }
...
TEST(GradientTest, SoftmaxCrossEntropyLoss) { softmax_cross_entropy_loss_grad_test<double>(); }
...
TEST(GradientTest, KullbackLieblerLoss) { kullback_leibler_loss_grad_test<double>(); }
...
TEST(GradientTest, MultiLabelHingeLoss) { multi_label_hinge_loss_grad_test<double>(); }
...
TEST(GradientTest, MultiLabelLogLoss) { multi_label_log_loss_grad_test<double>(); }
