...
int main() {
	...
	MNISTDataProvider<float> training_prov(mnist_folder + "train-images.idx3-ubyte", mnist_folder + "train-labels.idx1-ubyte");
	...
	NadamOptimizer<float,3,false> opt(loss, reg, 100);
