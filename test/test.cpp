...
int main() {
	...
	parallel_lanes.push_back(NeuralNetPtr<Scalar,RANK>(new FeedforwardNeuralNetwork<Scalar,RANK>(
	...
	comp_mods.push_back(NeuralNetPtr<Scalar,RANK>(new FeedforwardNeuralNetwork<Scalar,RANK>(std::move(layers1))));
