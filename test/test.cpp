...
int main() {
	...
	DataPair<float,3,false> test_data = file_test_prov.get_data(10000);
	TensorPtr<float,4> test_obs(new Tensor<float,4>(test_data.first));
	TensorPtr<float,4> test_obj(new Tensor<float,4>(test_data.second));
