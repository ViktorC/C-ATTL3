 ...
 * @param samples The total number of data samples to include in the training
 * data.
...
inline void ffnn_train_test(std::string name, OptimizerPtr<Scalar, Rank, false> opt,
                            const Dimensions<std::size_t, Rank> input_dims, unsigned samples, unsigned epochs,
                            Scalar epsilon = ScalarTraits<Scalar>::abs_epsilon) {
...
inline void rnn_train_test(std::string name, OptimizerPtr<Scalar, Rank, true> opt,
  ...
  NeuralNetPtr<Scalar, Rank, true> net = single_output_recurrent_neural_net<Scalar, Rank>(
      input_dims, [](int input_seq_length) { return std::make_pair(1, input_seq_length - 1); });
...
/**
 * Performs training tests using a vanilla stochastic gradient descent
 * optimizer.
 */
...
inline void vanilla_sgd_train_test() {
  ...
  ffnn_train_test<Scalar, 3>(
      "vanilla sgd batch",
      OptimizerPtr<Scalar, 3, false>(new VanillaSGDOptimizer<Scalar, 3, false>(loss, samples, 2e-3)), dims, samples,
      epochs, epsilon);
  ...
  rnn_train_test<Scalar, 3>(
      "vanilla sgd batch",
      OptimizerPtr<Scalar, 3, true>(new VanillaSGDOptimizer<Scalar, 3, true>(seq_loss, samples, 2e-3)), dims, samples,
      time_steps, epochs, seq_epsilon);
...
/**
 * Performs training tests using a momentum accelerated stochastic gradient
 * descent optimizer.
 */
template <typename Scalar>
inline void momentum_sgd_train_test() {
  ...
  auto loss = std::make_shared<SquaredLoss<Scalar, 3, false>>();
  ffnn_train_test<Scalar, 3>(
      "momentum accelerated sgd batch",
      OptimizerPtr<Scalar, 3, false>(new MomentumSGDOptimizer<Scalar, 3, false>(loss, samples, 2e-3)), dims, samples,
      epochs, epsilon);
  ffnn_train_test<Scalar, 3>(
      "momentum accelerated sgd mini-batch",
      OptimizerPtr<Scalar, 3, false>(new MomentumSGDOptimizer<Scalar, 3, false>(loss, 10, 1e-3, 1e-2, .99)), dims,
      samples, epochs, epsilon);
  ...
  rnn_train_test<Scalar, 3>(
      "momentum accelerated sgd batch",
      OptimizerPtr<Scalar, 3, true>(new MomentumSGDOptimizer<Scalar, 3, true>(seq_loss, samples, 2e-3)), dims, samples,
      time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>(
      "momentum accelerated sgd mini-batch",
      OptimizerPtr<Scalar, 3, true>(new MomentumSGDOptimizer<Scalar, 3, true>(seq_loss, 10, 1e-3, 1e-2, .99)), dims,
      samples, time_steps, epochs, seq_epsilon);
...
/**
 * Performs training tests using a nesterov momentum accelerated stochastic
...
inline void nesterov_momentum_sgd_train_test() {
  ...
  auto loss = std::make_shared<SquaredLoss<Scalar, 3, false>>();
  ffnn_train_test<Scalar, 3>(
      "nesterov momentum accelerated sgd batch",
      OptimizerPtr<Scalar, 3, false>(new NesterovMomentumSGDOptimizer<Scalar, 3, false>(loss, samples)), dims, samples,
      epochs, epsilon);
  ffnn_train_test<Scalar, 3>(
      "nesterov momentum accelerated sgd mini-batch",
      OptimizerPtr<Scalar, 3, false>(new NesterovMomentumSGDOptimizer<Scalar, 3, false>(loss, 10, 1e-3, 1e-2, .99)),
      dims, samples, epochs, epsilon);
  ffnn_train_test<Scalar, 3>(
      "nesterov momentum accelerated sgd online",
      OptimizerPtr<Scalar, 3, false>(new NesterovMomentumSGDOptimizer<Scalar, 3, false>(loss, 1, 5e-4)), dims, samples,
      epochs, epsilon);
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  rnn_train_test<Scalar, 3>(
      "nesterov momentum accelerated sgd batch",
      OptimizerPtr<Scalar, 3, true>(new NesterovMomentumSGDOptimizer<Scalar, 3, true>(seq_loss, samples)), dims,
      samples, time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>(
      "nesterov momentum accelerated sgd mini-batch",
  ...
  rnn_train_test<Scalar, 3>(
      "nesterov momentum accelerated sgd online",
      OptimizerPtr<Scalar, 3, true>(new NesterovMomentumSGDOptimizer<Scalar, 3, true>(seq_loss, 1, 5e-4)), dims,
      samples, time_steps, epochs, seq_epsilon);
}
...
inline void adagrad_train_test() {
  ...
  auto loss = std::make_shared<SquaredLoss<Scalar, 3, false>>();
  ffnn_train_test<Scalar, 3>(
      "adagrad batch", OptimizerPtr<Scalar, 3, false>(new AdaGradOptimizer<Scalar, 3, false>(loss, samples, 2.5e-2)),
      dims, samples, epochs, epsilon);
  ...
  ffnn_train_test<Scalar, 3>("adagrad online",
                             OptimizerPtr<Scalar, 3, false>(new AdaGradOptimizer<Scalar, 3, false>(loss)), dims,
                             samples, epochs, epsilon);
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  rnn_train_test<Scalar, 3>(
      "adagrad batch", OptimizerPtr<Scalar, 3, true>(new AdaGradOptimizer<Scalar, 3, true>(seq_loss, samples, 1e-2)),
      dims, samples, time_steps, epochs, seq_epsilon);
  ...
  rnn_train_test<Scalar, 3>("adagrad online",
                            OptimizerPtr<Scalar, 3, true>(new AdaGradOptimizer<Scalar, 3, true>(seq_loss)), dims,
                            samples, time_steps, epochs, seq_epsilon);
}
...
inline void rmsprop_train_test() {
  ...
  auto loss = std::make_shared<SquaredLoss<Scalar, 3, false>>();
  ffnn_train_test<Scalar, 3>(
      "rmsprop batch", OptimizerPtr<Scalar, 3, false>(new RMSPropOptimizer<Scalar, 3, false>(loss, samples, 1e-2)),
      dims, samples, epochs, epsilon);
  ffnn_train_test<Scalar, 3>(
      "rmsprop mini-batch",
      OptimizerPtr<Scalar, 3, false>(new RMSPropOptimizer<Scalar, 3, false>(loss, 10, 5e-3, 1e-2)), dims, samples,
      epochs, epsilon);
  ffnn_train_test<Scalar, 3>("rmsprop online",
                             OptimizerPtr<Scalar, 3, false>(new RMSPropOptimizer<Scalar, 3, false>(loss)), dims,
                             samples, epochs, epsilon);
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  rnn_train_test<Scalar, 3>(
      "rmsprop batch", OptimizerPtr<Scalar, 3, true>(new RMSPropOptimizer<Scalar, 3, true>(seq_loss, samples, 1e-2)),
      dims, samples, time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>(
      "rmsprop mini-batch",
      OptimizerPtr<Scalar, 3, true>(new RMSPropOptimizer<Scalar, 3, true>(seq_loss, 10, 5e-3, 1e-2)), dims, samples,
      time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>("rmsprop online",
                            OptimizerPtr<Scalar, 3, true>(new RMSPropOptimizer<Scalar, 3, true>(seq_loss)), dims,
                            samples, time_steps, epochs, seq_epsilon);
}
...
inline void adadelta_train_test() {
  ...
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  rnn_train_test<Scalar, 3>(
      "adadelta batch", OptimizerPtr<Scalar, 3, true>(new AdaDeltaOptimizer<Scalar, 3, true>(seq_loss, samples, 5e-2)),
      dims, samples, time_steps, epochs, seq_epsilon);
...
inline void adam_train_test() {
  ...
  ffnn_train_test<Scalar, 3>(
      "adam mini-batch",
      OptimizerPtr<Scalar, 3, false>(new AdamOptimizer<Scalar, 3, false>(loss, 10, 1e-3, 5e-2, 5e-3)), dims, samples,
      epochs, epsilon);
  ffnn_train_test<Scalar, 3>("adam online", OptimizerPtr<Scalar, 3, false>(new AdamOptimizer<Scalar, 3, false>(loss)),
                             dims, samples, epochs, epsilon);
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  ...
  rnn_train_test<Scalar, 3>(
      "adam mini-batch",
      OptimizerPtr<Scalar, 3, true>(new AdamOptimizer<Scalar, 3, true>(seq_loss, 10, 1e-3, 5e-2, 5e-3)), dims, samples,
      time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>("adam online", OptimizerPtr<Scalar, 3, true>(new AdamOptimizer<Scalar, 3, true>(seq_loss)),
                            dims, samples, time_steps, epochs, seq_epsilon);
}
...
inline void adamax_train_test() {
  ...
  ffnn_train_test<Scalar, 3>(
      "adamax mini-batch",
      OptimizerPtr<Scalar, 3, false>(new AdaMaxOptimizer<Scalar, 3, false>(loss, 10, 1e-3, 5e-2, 5e-3)), dims, samples,
      epochs, epsilon);
  ffnn_train_test<Scalar, 3>("adamax online",
                             OptimizerPtr<Scalar, 3, false>(new AdaMaxOptimizer<Scalar, 3, false>(loss)), dims, samples,
                             epochs, epsilon);
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  rnn_train_test<Scalar, 3>(
      "adamax batch", OptimizerPtr<Scalar, 3, true>(new AdaMaxOptimizer<Scalar, 3, true>(seq_loss, samples, 5e-3)),
      dims, samples, time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>(
      "adamax mini-batch",
      OptimizerPtr<Scalar, 3, true>(new AdaMaxOptimizer<Scalar, 3, true>(seq_loss, 10, 1e-3, 5e-2, 5e-3)), dims,
      samples, time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>("adamax online",
                            OptimizerPtr<Scalar, 3, true>(new AdaMaxOptimizer<Scalar, 3, true>(seq_loss)), dims,
                            samples, time_steps, epochs, seq_epsilon);
}
...
inline void nadam_train_test() {
  ...
  ffnn_train_test<Scalar, 3>(
      "nadam mini-batch",
      OptimizerPtr<Scalar, 3, false>(new NadamOptimizer<Scalar, 3, false>(loss, 10, 1e-3, 5e-2, 5e-3)), dims, samples,
      epochs, epsilon);
  ffnn_train_test<Scalar, 3>("nadam online", OptimizerPtr<Scalar, 3, false>(new NadamOptimizer<Scalar, 3, false>(loss)),
                             dims, samples, epochs, epsilon);
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  ...
  rnn_train_test<Scalar, 3>(
      "nadam mini-batch",
      OptimizerPtr<Scalar, 3, true>(new NadamOptimizer<Scalar, 3, true>(seq_loss, 10, 1e-3, 5e-2, 5e-3)), dims, samples,
      time_steps, epochs, seq_epsilon);
  rnn_train_test<Scalar, 3>("nadam online",
                            OptimizerPtr<Scalar, 3, true>(new NadamOptimizer<Scalar, 3, true>(seq_loss)), dims, samples,
                            time_steps, epochs, seq_epsilon);
}
...
inline void amsgrad_train_test() {
  ...
  auto loss = std::make_shared<SquaredLoss<Scalar, 3, false>>();
  ffnn_train_test<Scalar, 3>(
      "amsgrad batch", OptimizerPtr<Scalar, 3, false>(new AMSGradOptimizer<Scalar, 3, false>(loss, samples, 1e-2)),
      dims, samples, epochs, epsilon);
  ...
  ffnn_train_test<Scalar, 3>("amsgrad online",
                             OptimizerPtr<Scalar, 3, false>(new AMSGradOptimizer<Scalar, 3, false>(loss)), dims,
                             samples, epochs, epsilon);
  auto seq_loss = std::make_shared<SquaredLoss<Scalar, 3, true>>();
  rnn_train_test<Scalar, 3>(
      "amsgrad batch", OptimizerPtr<Scalar, 3, true>(new AMSGradOptimizer<Scalar, 3, true>(seq_loss, samples, 5e-3)),
      dims, samples, time_steps, epochs, seq_epsilon);
  ...
  rnn_train_test<Scalar, 3>("amsgrad online",
                            OptimizerPtr<Scalar, 3, true>(new AMSGradOptimizer<Scalar, 3, true>(seq_loss)), dims,
                            samples, time_steps, epochs, seq_epsilon);
}
