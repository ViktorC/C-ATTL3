...
//namespace cppnn {
//
//double QuadraticLoss::function(std::vector<double>& out, std::vector<double>& obj) const {
...
//	return loss/2;
//};
//double QuadraticLoss::d_function(std::vector<double>& out, double error) const {
//	return 0;
//};
//
//}
