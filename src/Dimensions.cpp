...
Dimensions::Dimensions() :
		Dimensions(1, 1, 1) { };
Dimensions::Dimensions(int dim1, int dim2, int dim3) :
		dim1(dim1),
		dim2(dim2),
		dim3(dim3) {
	assert(dim1 > 0 && dim2 > 0 && dim3 > 0);
};
int Dimensions::get_dim1() const {
	return dim1;
};
int Dimensions::get_dim2() const {
	return dim2;
};
int Dimensions::get_dim3() const {
	return dim3;
};
int Dimensions::get_points() const {
