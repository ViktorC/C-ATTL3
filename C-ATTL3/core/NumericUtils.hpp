...
class NumericUtils {
 ...
 public:
   ...
   */
  inline static bool almost_equal(Scalar n1, Scalar n2, Scalar abs_epsilon = EPSILON1, Scalar rel_epsilon = EPSILON1) {
  ...
  /**
   * Returns whether a numeral is greater than another one by a margin great
   * enough for them not to be considered almost equal.
   *
   * @param n1 The first numeral.
   * @param n2 The second numeral.
   * @param abs_epsilon The maximum absolute difference that would still allow
   ...
   * @param rel_epsilon The maximum relative (to the greater numeral of the two)
   * difference that would still allow them to be considered equal.
   * @return Whether the the first numeral is sufficiently greater than the
   * second.
   */
  ...
  /**
   * Returns whether a numeral is not lesser than another one by a margin great
   * enough for them not to be considered almost equal.
   *
   * @param n1 The first numeral.
   * @param n2 The second numeral.
   ...
   * @param rel_epsilon The maximum relative (to the greater numeral of the two)
   * difference that would still allow them to be considered equal.
   * @return Whether the the first numeral is sufficiently great enough not to
   * be considered decidedly smaller than the second.
   */
  ...
  /**
   * Returns whether a numeral is lesser than another one by a margin great
   * enough for them not to be considered almost equal.
   *
   * @param n1 The first numeral.
   * @param n2 The second numeral.
   ...
   * @param rel_epsilon The maximum relative (to the greater numeral of the two)
   * difference that would still allow them to be considered equal.
   * @return Whether the the first numeral is sufficiently lesser than the
   * second.
   */
  ...
  /**
   * Returns whether a numeral is not greater than another one by a margin great
   * enough for them not to be considered almost equal.
   *
   * @param n1 The first numeral.
   * @param n2 The second numeral.
   ...
   * @param rel_epsilon The maximum relative (to the greater numeral of the two)
   * difference that would still allow them to be considered equal.
   * @return Whether the the first numeral is sufficiently small enough not to
   * be considered decidedly greater than the second.
   */
