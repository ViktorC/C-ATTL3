...
class Parameters {
 public:
  ...
  /**
   * @param values The new values of the parameters. The matrix is expected to
   * havey the dimensions specified by the get_rows() and get_cols() methods.
   */
  ...
  /**
   * @param grad The values to add to the current gradient of the parameters.
   * The matrix is expected to have the dimensions specified by the get_rows()
   * and get_cols() methods.
   */
  ...
  /**
   * It adds the derivative of the regularization function w.r.t. to the
   * parameters to the gradient.
   */
  ...
  /**
   * @param frozen Whether the parameters are to be frozen, i.e. not to be
   * updated.
   */
