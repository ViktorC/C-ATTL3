...
public:
	...
	inline DenseKernelLayer(const Dimensions<std::size_t,Rank>& input_dims, std::size_t output_size,
			ParamInitSharedPtr<Scalar> weight_init, ParamRegSharedPtr<Scalar> weight_reg = Root::NO_PARAM_REG,
...
protected:
	inline ConvKernelLayerBase(const Dimensions<std::size_t,Rank>& input_dims, std::size_t filters,
			ParamInitSharedPtr<Scalar> weight_init, ParamRegSharedPtr<Scalar> weight_reg, std::size_t receptor_height,
...
public:
	 ...
	 * constraint is applied.
	 */
	inline ConvKernelLayer(const Dimensions<std::size_t,3>& input_dims, std::size_t filters, ParamInitSharedPtr<Scalar> weight_init,
...
public:
	 ...
	 * constraint is applied.
	 */
	inline ConvKernelLayer(const Dimensions<std::size_t,2>& input_dims, std::size_t filters, ParamInitSharedPtr<Scalar> weight_init,
			ParamRegSharedPtr<Scalar> weight_reg = Root::NO_PARAM_REG, std::size_t receptor_height = 3, std::size_t receptor_width = 3,
			std::size_t vertical_padding = 1, std::size_t horizontal_padding = 1, std::size_t vertical_stride = 1,
			std::size_t horizontal_stride = 1, std::size_t vertical_dilation = 0, std::size_t horizontal_dilation = 0,
			Scalar max_norm_constraint = 0) :
...
public:
	 ...
	 * constraint is applied.
	 */
	ConvKernelLayer(const Dimensions<std::size_t,1>& input_dims, std::size_t filters, ParamInitSharedPtr<Scalar> weight_init,
...
public:
	 ...
	 * constraint is applied.
	 */
	inline DeconvKernelLayer(const Dimensions<std::size_t,3>& input_dims, std::size_t filters, ParamInitSharedPtr<Scalar> weight_init,
			ParamRegSharedPtr<Scalar> weight_reg = Root::NO_PARAM_REG, std::size_t receptor_height = 3, std::size_t receptor_width = 3,
			std::size_t vertical_padding = 1, std::size_t horizontal_padding = 1, std::size_t vertical_stride = 1,
			std::size_t horizontal_stride = 1, std::size_t vertical_dilation = 0, std::size_t horizontal_dilation = 0,
			Scalar max_norm_constraint = 0) :
...
public:
	 ...
	 * constraint is applied.
	 */
	DeconvKernelLayer(const Dimensions<std::size_t,2>& input_dims, std::size_t filters, ParamInitSharedPtr<Scalar> weight_init,
			ParamRegSharedPtr<Scalar> weight_reg = Root::NO_PARAM_REG, std::size_t receptor_height = 3, std::size_t receptor_width = 3,
			std::size_t vertical_padding = 1, std::size_t horizontal_padding = 1, std::size_t vertical_stride = 1,
			std::size_t horizontal_stride = 1, std::size_t vertical_dilation = 0, std::size_t horizontal_dilation = 0,
			Scalar max_norm_constraint = 0) :
...
public:
	 ...
	 * constraint is applied.
	 */
	DeconvKernelLayer(const Dimensions<std::size_t,1>& input_dims, std::size_t filters, ParamInitSharedPtr<Scalar> weight_init,
			ParamRegSharedPtr<Scalar> weight_reg = Root::NO_PARAM_REG, std::size_t receptor_length = 3, std::size_t padding = 1,
			std::size_t stride = 1, std::size_t dilation = 0, Scalar max_norm_constraint = 0) :
