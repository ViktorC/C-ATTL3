...
#ifndef C_ATTL3_CORE_CODEC_H_
#define C_ATTL3_CORE_CODEC_H_
...
class Codec {
 public:
   ...
   * @param file_path The path to the file to which the encoded data should be
   * written. If it does not exist, it will be created; if it does, the encoded
   * data is appended to the contents of the file.
   */
