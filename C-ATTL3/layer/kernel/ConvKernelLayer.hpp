			...
			Scalar bias_grad_max_l1_norm, Scalar bias_grad_max_l2_norm) :
				...
				Base::KernelLayer(input_dims, calculate_adjusted_output_dims(input_dims, filters,
						...
						std::make_shared<HostParameters<Scalar>>(receptor_height * receptor_width *
								input_dims.template extend<3 - Rank>()(2), filters, weight_init,
						...
						std::make_shared<HostParameters<Scalar>>(1, filters,
								std::make_shared<ZeroParameterInitialization<Scalar>>(), true, bias_reg,
