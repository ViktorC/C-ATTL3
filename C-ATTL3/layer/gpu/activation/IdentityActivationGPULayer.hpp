...
class IdentityActivationGPULayer : public ActivationGPULayer<Scalar, Rank> {
 ...
 public:
  inline IdentityActivationGPULayer(const typename Root::Dims& dims) : Base(dims) {}
  inline GPULayer<Scalar, Rank>* gpu_clone() const { return new IdentityActivationGPULayer<Scalar, Rank>(*this); }
