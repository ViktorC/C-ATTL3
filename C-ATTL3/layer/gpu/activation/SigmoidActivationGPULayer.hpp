...
class SigmoidActivationGPULayer : public SimpleActivationGPULayer<Scalar, Rank> {
 ...
 public:
  inline SigmoidActivationGPULayer(const typename Root::Dims& dims) : Base(dims, CUDNN_ACTIVATION_SIGMOID) {}
  inline GPULayer<Scalar, Rank>* gpu_clone() const { return new SigmoidActivationGPULayer<Scalar, Rank>(*this); }
};
