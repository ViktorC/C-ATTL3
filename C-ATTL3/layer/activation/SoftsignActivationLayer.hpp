...
/**
 * A class template representing a softsign activation function layer, an
 * alternative to the tanh layer.
 *
...
class SoftsignActivationLayer : public ActivationLayer<Scalar, Rank> {
 ...
 public:
   ...
   */
  inline SoftsignActivationLayer(const typename Root::Dims& dims) : Base::ActivationLayer(dims) {}
  inline Root* clone() const { return new SoftsignActivationLayer(*this); }
  inline void empty_cache() { denom_cache = typename Root::Data(); }
