...
/**
 * A class template representing a rectified linear unit (ReLU) activation
 function. ReLU
 * layers set all negative elements of the input to 0. This function is not
 differentiable.
...
class ReLUActivationLayer : public ActivationLayer<Scalar, Rank> {
 ...
 public:
   ...
   */
  inline ReLUActivationLayer(const typename Root::Dims& dims) : Base::ActivationLayer(dims) {}
  inline Root* clone() const { return new ReLUActivationLayer(*this); }
