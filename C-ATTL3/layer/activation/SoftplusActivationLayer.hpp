...
/**
 * A class template representing a softplus activation function layer. The
 * softplus activation function is a differentiable function that approximates
...
class SoftplusActivationLayer : public ActivationLayer<Scalar, Rank> {
 ...
 public:
   ...
   */
  inline SoftplusActivationLayer(const typename Root::Dims& dims) : Base::ActivationLayer(dims) {}
  inline Root* clone() const { return new SoftplusActivationLayer(*this); }
