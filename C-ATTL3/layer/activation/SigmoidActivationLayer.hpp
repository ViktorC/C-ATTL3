...
class SigmoidActivationLayer : public ActivationLayer<Scalar, Rank> {
 ...
 public:
   ...
   */
  inline SigmoidActivationLayer(const typename Root::Dims& dims) : Base::ActivationLayer(dims) {}
  inline Root* clone() const { return new SigmoidActivationLayer(*this); }
  inline void empty_cache() { out_cache = typename Root::Data(); }
