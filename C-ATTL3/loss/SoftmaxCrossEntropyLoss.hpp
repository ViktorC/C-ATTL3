...
/**
 * A loss function template that applies the softmax function to its input
 * before calculating the cross entropy loss. This allows for increased
 * numerical stability and faster computation.
 *
...
class SoftmaxCrossEntropyLoss : public UniversalLoss<Scalar, Rank, Sequential> {
 ...
 public:
   ...
   */
  SoftmaxCrossEntropyLoss(Scalar epsilon = NumericUtils<Scalar>::EPSILON2) : epsilon(epsilon){};
