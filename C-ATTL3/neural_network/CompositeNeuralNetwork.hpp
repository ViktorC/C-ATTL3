...
/**
 * An alias for a unique pointer to a neural network of arbitrary scalar type,
 * rank, and sequentiality.
 */
template <typename Scalar, std::size_t Rank, bool Sequential>
using NeuralNetPtr = std::unique_ptr<NeuralNetwork<Scalar, Rank, Sequential>>;

/**
 * A class template for composite neural networks consisting of one or more
