...
TensorPtr<double,4> train_obs_ptr(new Tensor<double,4>(80u, 32u, 32u, 3u));
TensorPtr<double,4> train_obj_ptr(new Tensor<double,4>(80u, 1u, 1u, 1u));
...
MemoryDataProvider<double,3,false> train_prov(std::move(train_obs_ptr), std::move(train_obj_ptr));
```
...
layers[0] = LayerPtr<double,3>(new ConvolutionLayer<double>(train_prov.get_obs_dims(), 10, init, reg, 5, 5, 2, 2));
